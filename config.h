...
static const Bool viewontag         = 1;     /* Switch view on tag switch */
static const char *fonts[]          = { "VictorMono Nerd Font:size=12" };
static const char dmenufont[]       = "VictorMono Nerd Font:size=12";
